...
void BAPGDYT04Partitioner::Print(const int& aWidth,
                             const int& aDetail) const
{
   cout  << "--== BAPGDYT04Partitioner ==--" << endl
         << "  ID = " << ID() << endl
         << "  Name = " << Name() << endl
...
unsigned int BAPGDYT04Partitioner::TotalFlow(const int& v1, const int& v2) const
{
   return (unsigned int) (mTrans(v1, v2) + mTrans(v2, v1));
}

unsigned int BAPGDYT04Partitioner::TotalFlow(const TVVessel& v1, const TVVessel& v2) const
{
...
unsigned int BAPGDYT04Partitioner::D(const TVSection& s1, const TVSection& s2) const
{
...
void BAPGDYT04Partitioner::WriteSolutionFile() const
{
   ...
   SolFile  << "#" << endl
            << "# Solution File created by BAPGDYT04Partitioner" << endl
            << "# Date = " << Date()
